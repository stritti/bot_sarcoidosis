...
TWITTER_ACCESS_SECRET   = "XXXQ";
TWITTER_SEARCH_PHRASE   = "(#sarcoidose OR #sarcoidosis OR #sarcoid OR @sarcoid_papers) -RT"; // ex. "#DevFest -RT" (the "-RT" excludes re-Tweets)
...
function hashtag_twitterBot() {
  try {
    Logger.log("Looking for retweet & fav: '" + TWITTER_SEARCH_PHRASE + "' ...");
    var props = PropertiesService.getScriptProperties(),
